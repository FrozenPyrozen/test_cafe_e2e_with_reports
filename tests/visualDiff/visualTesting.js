...
// to check difference run: npx testcafe-blink-diff tests/screenshots --compare base:actual --open --threshold 0.03
...
test("Google Testing after search - Var 1", async (t) => {
  ...
  //Page interactions
  await t.typeText("input.gLFyf", "John Doe").click("input.gNO89b");
